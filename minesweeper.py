...
class MinesweeperAI():
    ...
    def getNeighbours(self, cell):
        '''returns the neighbours of a cell and their mine count'''
        i, j = cell
        neighbours =  set()
    ...
    def add_knowledge(self, cell, count):
        ...
        created_sentence = Sentence(neighbours, count)
        ...
        for sen in self.knowledge:
            ...
            #list them to avoid issues when iterating
        ...
        for following_sentence in self.knowledge:
            if len(following_sentence.cells) == 0:
                ...
                break
            #elif sentence subset of following sentence
